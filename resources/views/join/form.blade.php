<x-app-layout>
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/join">{{ __('Benefit') }}</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="div-top">
            <a class="btn btn-default" href="{{ route('join') }}">{{ __('Back') }}</a>
        </div>
        ...
        <div class="card bg-white shadow default-border-radius">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ route('join.save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" placeholder="Name" type="text" id="place" name="name" value="{{old('name', (isset($model->name) ? $model->name : ''))}}"  required="true">
                        </div>
                    </div>

            ...
            <div class="col-12 d-flex no-block align-items-center">
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">{{ __('Join Abblesearch') }}</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="card bg-white shadow default-border-radius">
            <div class="card-body">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('join.description.save') }}" enctype="multipart/form-data">
                    {{ csrf_field() }} 

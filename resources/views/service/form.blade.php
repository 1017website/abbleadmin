<x-app-layout>
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/service">{{ __('Service') }}</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="div-top">
            <a class="btn btn-default" href="{{ route('service') }}">{{ __('Back') }}</a>
        </div>
        ...
        <div class="card bg-white shadow default-border-radius">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ route('service.save') }}" method="POST" enctype="multipart/form-data">
                    @csrf

<x-app-layout>
            ...
            <div class="col-12 d-flex no-block align-items-center">
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/people">{{ __('Specializations') }}</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="div-top">
            <a class="btn btn-default" href="{{ route('specializations') }}">{{ __('Back') }}</a>
        </div>
        ...
        <div class="card bg-white shadow default-border-radius">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ route('specializations.save') }}" method="POST" enctype="multipart/form-data">
                    @csrf

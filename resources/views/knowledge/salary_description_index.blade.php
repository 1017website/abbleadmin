                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/knowledge-salary-description">{{ __('Salary Surveys') }}</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card bg-white shadow default-border-radius">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ route('knowledge.salary.description.save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
